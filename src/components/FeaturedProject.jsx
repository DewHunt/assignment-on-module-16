...
const FeaturedProject = async () => {
  ...
  return (
    <div className="w-full h-[1100px] bg-green-50">
      <div className="px-16 pt-10 pb-5 text-green-500 text-xl font-medium font-['Poppins'] uppercase">
        Featured Project
      </div>
      <div className="w-[595px] px-16 pb-5 text-black text-3xl font-semibold font-['Poppins']">
      ...
      <div className="grid grid-cols-4 gap-4 px-20 py-10">
        {featuredProjects.map((project) => {
          return (
            <div className="m-2">
              <img className="rounded-[20px]" src={project.image} />
