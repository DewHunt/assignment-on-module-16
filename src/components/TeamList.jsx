      ...
      <div className="pl-[105px] pr-[45px] pt-[67px] pb-[84px] bg-white flex-col justify-start items-start gap-[66px] inline-flex">
        ...
        <div className="self-stretch h-[490px] pr-[54px] pb-1.5 justify-start items-start gap-8 inline-flex">
          <div className="grid grid-cols-4 gap-4 px-20 py-10">
            {teamList.map((team) => {
              return (
                <div className="w-[365px] h-[490px] relative">
                  <div className="w-[365px] h-[490px] left-0 top-0 absolute bg-white rounded-[20px] shadow border border-neutral-200"></div>
                  <img
                    className="w-[365px] h-[387px] left-0 top-0 absolute rounded-tl-[20px] rounded-tr-[20px]"
                    src={team.image}
                  />
                  <div className="w-[145px] h-[50px] left-[120px] top-[307px] absolute">
                    <div className="w-[145px] h-[50px] left-0 top-0 absolute bg-white rounded-[25px] shadow"></div>
                    <div className="left-[21px] top-[17px] absolute text-gray-500 text-base font-normal">
                      <FaFacebookF />
                    </div>
                    <div className="left-[111px] top-[17px] absolute text-gray-500 text-base font-normal font-['Font Awesome 6 Brands']">
                      <FaInstagram />
                    </div>
                    <div className="left-[63px] top-[17px] absolute text-gray-500 text-base font-normal font-['Font Awesome 6 Brands']">
                      <FaTwitter />
                    </div>
