    ...
    <div className="w-full px-[422px] pt-[91px] pb-[137px] bg-white justify-center items-center inline-flex">
      <div className="self-stretch flex-col justify-center items-center gap-10 inline-flex">
        <div className="flex-col justify-start items-center gap-[5px] flex">
          ...
          <div className="text-center text-zinc-500 text-base font-medium font-['Avenir'] capitalize">
            Please drop your email below to get daily update about what we do
          </div>
        </div>
        <div className="h-[62px] flex-col justify-start items-end flex">
          <div className="w-[596px] px-4 py-2 rounded-[14px] border border-black justify-start items-center gap-2.5 inline-flex">
            <input
              type="text"
              name="email"
            ...
            />
            <div className="w-[130.65px] px-[24.32px] py-[8.11px] bg-orange-600 rounded-[14px] justify-center items-center gap-[8.11px] flex">
              <button className="text-white px-[24.32px] py-[8.11px] text-base font-medium font-['Poppins']">
                Subscribe
              </button>
            </div>
          </div>
